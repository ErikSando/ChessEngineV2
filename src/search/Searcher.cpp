...
//         REDUCTION_TABLE[depth] = REDUCTION_FACTOR * std::log(depth);
//     }
// }
...
//             //int reduction = std::clamp((legalMoves - FULL_DEPTH_MOVES) / 3, 0, MAX_REDUCTION); // reduce depth by 1 for every 3 moves searched until the maximum is hit
