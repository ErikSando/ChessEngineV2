...
//                 move = EncodeMove(kingSquare, toSquare, kingPiece, captured, 0, CAPTURE_FLAG);
//                 score = MvvLvaScore[PIECE_TYPE[captured]][K];
//             }
//             else {
//                 move = EncodeMove(kingSquare, toSquare, kingPiece, captured, 0, 0);
//                 score = GetScore(board, move, piece + 6, toSquare);
//             }
