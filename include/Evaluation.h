...
namespace Evaluation {
    ...
    extern const int* PieceMgTables[6];
    extern const int* PieceEgTables[6];
    ...
    // bonuses and penalties, not implemented yet
    namespace Heuristics {
        constexpr int Tempo = 10;
        constexpr int BishopPair = 30;
        constexpr int RookOpenFile = 30;
        constexpr int DoubledPawn = -15;
        constexpr int PassedPawn = 20;

        // add some king safety bonuses/penalties
    }
