...
namespace ErikEngine {
    ...
    namespace EvalParams {
        ...
        constexpr int PieceValuesOp[6] = { 100, 320, 330, 500, 950, 0 };
        ...
        constexpr int MobilityValueOp[12] = { 0, 4, 3, 1, 0, 0, 0, 4, 3, 1, 1, 0 };
        ...
        constexpr int PawnTableEg[64] = {
            ...
            constexpr int KnightTableOp[64] = {
        ...
        constexpr int BishopTableOp[64] = {
